...
<main>
    <div class="order-summary-container">
        <div class="summary-header">
            ...
            <a href="staffOrders.php" class="back-btn">← Back to Orders</a>
        </div>
        ...
        <div class="summary-grid">
            ...
            <div class="summary-card">
                ...
                <div class="info-row">
                    ...
                    <span class="value"><?php echo ucwords(str_replace('_', ' ', $order['order_status'])); ?></span>
                </div>
                <div class="info-row">
                    <span class="label">Payment Status:</span>
                    <span class="value"><?php echo ucwords(str_replace('_', ' ', $order['payment_status'])); ?></span>
                </div>
            </div>
